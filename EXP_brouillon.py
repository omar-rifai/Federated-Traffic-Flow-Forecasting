...
def experiment_dataset(cluster_size,df,name ='ClusterS'):
    ...
    with open('./experiment/{}{}.pkl'.format(name,cluster_size), 'wb') as f:
...
# load the experiment datasets from pickle object 
    ...
    with open('./experiment/newS1.pkl'.format(i), 'wb') as f:
